...
<div class="reportSummary formSep">
	<h1>This Week's Report - <?php echo date('n/d/y',strtotime($dateRange['start'])).' - '.date('n/d/y',strtotime($dateRange['end']));?></h1>
	<h2>By Category</h2>
	<?php
...
<div>
	<button id="printReport-this_week" type="button" class="printReport btn btn-primary btn-large">Print Report</button>
</div>